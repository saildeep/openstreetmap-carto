...
@grass: transparent;        // Lch(90,32,128) also grassland, meadow, village_green, garden, allotments
@scrub: transparent;        // Lch(84,24,122)
@forest: transparent;       // Lch(80,30,135)
@forest-text: #46673b;  // Lch(40,30,135)
@park: transparent;         // Lch(94,30,145)
@allotments: transparent;   // Lch(87,20,135)
@orchard: transparent; // also vineyard, plant_nursery
@hedge: @forest;       // Lch(80,30,135)

// --- "Base" landuses ---

@built-up-lowzoom:  transparent;
@built-up-z11:  transparent;
@built-up-z12:  transparent;
@residential: transparent;      // Lch(89,0,0)
@residential-line: #b9b9b9; // Lch(75,0,0)
@retail:  transparent;           // Lch(89,16,30)
@retail-line: #d99c95;      // Lch(70,25,30)
@commercial:  transparent;       // Lch(89,8.5,25)
@commercial-line: #d1b2b0;  // Lch(75,12,25)
@industrial:  transparent;       // Lch(89,9,330) (Also used for railway, wastewater_plant)
@industrial-line: #c6b3c3;  // Lch(75,11,330) (Also used for railway-line, wastewater_plant-line)
@farmland:  transparent;         // Lch(94,14,112)
@farmland-line: #c7c9ae;    // Lch(80,14,112)
@farmyard: transparent;         // Lch(89,20,80)
@farmyard-line: #d1b48c;    // Lch(75,25,80)

// --- Transport ----

@transportation-area: transparent;
@apron:  transparent;
@garages:  transparent;
@parking: transparent;
...
@rest_area:  transparent; // also services

// --- Other ----

@bare_ground: transparent;
@campsite: transparent; // also caravan_site, picnic_site
@cemetery: transparent; // also grave_yard
@construction: transparent; // also brownfield
@heath: transparent;
@mud: transparent; // produces #e6dcd1 over @land
@place_of_worship: transparent; // also landuse_religious
@place_of_worship_outline: darken(@place_of_worship, 30%);
@leisure: lighten(@park, 5%);
@power: darken(@industrial, 5%);
@power-line: darken(@industrial-line, 5%);
@sand: transparent;
@societal_amenities: transparent;   // Lch(99,13,109)
@tourism: transparent;
@quarry:transparent;
